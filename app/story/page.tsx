    ...
    <main className="min-h-[100svh] bg-brand-bg-primary pb-24 pt-28">
      ...
      <motion.div {...containerProps} className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div {...childProps} className="relative aspect-[16/9] w-full overflow-hidden rounded-3xl sm:aspect-[21/9]">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-brand-bg-primary via-transparent to-transparent opacity-90" />
          <div className="absolute bottom-0 left-0 w-full p-6 sm:p-10">
            <h2 className="font-heading text-2xl font-semibold text-brand-text-primary sm:text-4xl text-shadow-sm">
        ...
        {/* Editorial Prose */}
        <motion.div {...childProps} className="mx-auto mt-16 max-w-3xl space-y-8 font-body text-base leading-relaxed text-brand-text-secondary sm:text-lg">
          <p>
          ...
          <p>
            At the absolute core of our kitchen is an uncompromising commitment to original recipe integrity. We believe that true flavour cannot be rushed. Our signature <span className="font-semibold text-brand-text-primary">Tikka Kabab</span> and <span className="font-semibold text-brand-text-primary">Mutton Champ</span> are the direct results of painstaking marinades, secret hand-ground spice blends passed down through generations, and the irreplaceable, primal magic of live charcoal grilling.
          </p>
          <div className="my-10 border-l-2 border-brand-accent-gold pl-6 italic">
          ...
          <p className="font-semibold text-brand-accent-gold">
